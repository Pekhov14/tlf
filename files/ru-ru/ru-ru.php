...
$_['text_store']           = 'Интернет-магазин MOTOSTYLE';
$_['text_yes']              = 'Да';
$_['text_no']               = 'Нет';
...
$_['consent_personal_data'] = 'Подтверждая отправку Вы&nbsp;соглашаетесь с&nbsp;<a href="privacy-policy" target="_blank">политикой&nbsp;конфиденциальности</a> и&nbsp;даёте согласие на обработку персональных данных';
// Buttons
...
$_['text_page']				= 'Cтраница ';
$_['text_filter']           = 'Фильтр';
$_['text_clear_filter']     = 'Очистить';
$_['text_display_only']     = 'Отображать только:';
$_['text_promotions']       = 'Акции';
$_['text_stock']        	= 'Акция';
$_['text_top_sales']        = 'Топ продаж';
$_['text_new_arrivals']     = 'Новинки';
$_['text_new']    			= 'Новинка';
$_['text_recommended']      = 'Рекомендуем';
$_['text_all']              = 'Все';
$_['text_more_details']		= 'Подробнее';